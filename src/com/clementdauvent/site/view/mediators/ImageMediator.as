package com.clementdauvent.site.view.mediators
{
	...
	public class ImageMediator extends Mediator
	{
		...
		override public function onRegister():void
		{
			...
			img.addEventListener(MouseEvent.MOUSE_OVER, img_mouseOverHandler);
		}
		...
		protected function img_mouseOverHandler(e:MouseEvent):void
		{
			e.stopImmediatePropagation();
			eventDispatcher.dispatchEvent(new ElementEvent(ElementEvent.IMG_MOUSE_OVER, img.description));
		}
	}
}